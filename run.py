...
def clear():
    os.system('cls' if os.name == 'nt' 'clear')
     ...
     This function uses a system call to clear the terminal screen to keep the display clean.
...
def display_instructions():
    ...
    This function prints out the instructions for the Human Anatomy Quiz, explaining how to play,
...
def new_game():
    ...
    This function initializes a new game with a set of predefined questions. Each question is presented
    to the user along with multiple choice answers. The user's responses are evaluated, and feedback is
    provided. The total score is displayed at the end of the session.
    """
    clear()
    questions = [
        # Questions are defined here with their options and the correct answer.
           {
    ...
    for q in questions:
        # For each question, clear the screen, display the question and options, and prompt for an answer.
        clear()
        print("\n" + q["question"])
    ...
    # Display the final score and return to the menu.        
    clear()
...
def menu():
    ...
    This function presents the main menu of the game, allowing the user to choose between starting a new game,
    viewing instructions, or quitting. It processes the user's input and directs to the appropriate action.
    """
    while True:
        clear()
